    ...
    <div id="wd-working-with-arrays">
      ...
      <div className="form-check form-switch float-start">
        <input
          ...
          defaultChecked={todo.completed} // Bind state to the checkbox
          onChange={(e) =>
            setTodo({ ...todo, completed: e.target.checked })} // Update state on change
        />
        <label className="form-check-label" htmlFor="wd-todo-completed">
          {todo.completed ? "True" : "False"} {/* Show current boolean state */}
        </label>
      </div><br /><br />
      <hr />
