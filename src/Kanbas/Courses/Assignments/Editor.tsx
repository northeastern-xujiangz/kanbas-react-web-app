  ...
  return (
    <div id="wd-assignments-editor" className="container">
      ...
      <div className="mb-3">
        ...
        <textarea className="form-control" id="wd-name" value={assignment && assignment.title}
                  rows={3}></textarea>
      </div>
      ...
      <br/>
      <hr />
      <Link id="wd-save-btn" to={`/Kanbas/Courses/${cid}/Assignments`} className="btn btn-danger me-1 float-end">
        Save</Link>
